        ...
        <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-5xl">
            <div class="md:flex">
                <div class="w-full px-4 py-6 bg-gray-100 dark:bg-gray-900">
                    ...
                    <p class="mt-3 text-gray-600 dark:text-gray-400">Fill out the form below to send us an email and we'll get back to you as
                        soon as possible.</p>
                    <form class="mt-6" method="POST" action="{{ route('contact.store') }}">
                        @csrf
                        <div class="mb-6">
                            <label class="block text-gray-700 dark:text-gray-300 font-bold mb-2" for="name">Name</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-gray-700 dark:text-gray-300 font-bold mb-2" for="email">Email</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-gray-700 dark:text-gray-300 font-bold mb-2" for="phone">Phone</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-gray-700 dark:text-gray-300 font-bold mb-2" for="message">Message</label>
