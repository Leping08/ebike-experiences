...
@section('content')
    ...
    <div class="overflow-hidden bg-white dark:bg-gray-900 py-32">
            ...
            <div
                ...
                <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                    ...
                    <p class="mt-6 text-xl leading-8 text-gray-600 dark:text-gray-300">The Legacy Trail is a popular
                        multi-use trail located in Sarasota County, Florida. It is a paved trail that is open to cyclists,
                        walkers, runners, and inline skaters, and is approximately 10.6 miles long.</p>
                    <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">The trail starts at the southern end
                        in Sarasota at the historic train station on McIntosh Road and extends to Venice, Florida. The trail
                        winds through scenic landscapes of natural beauty, including wetlands, parks, and wildlife areas.
                    </p>
                    <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">Along the way, visitors can explore
                    ...
                    <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">The Legacy Trail is well-maintained
                    ...
                    <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">Overall, The Legacy Trail is a
                        popular and scenic destination for outdoor enthusiasts, and is highly recommended for anyone looking
        ...
        <div class="mx-auto mt-12 max-w-7xl px-6 sm:mt-8 lg:px-8 xl:mt-8">
                ...
                <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                    <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
                        <div class="mt-10 max-w-xl text-base leading-7 text-gray-700 dark:text-gray-300">
                            <p>The Legacy Trail is a 12.5-mile trail in Sarasota County that follows the scenic CSX railroad
                                corridor, offering opportunities for recreation, historical discovery, and environmental
                                appreciation. The restored Venice Train Depot serves as a historical resource and regional
                                transportation hub. In 2018, voters approved a bond referendum to extend the Legacy Trail an
                                additional 7.5 miles north to Payne Park in downtown Sarasota with a connector to the City
                                of North Port. The grade level trail part of this extension was completed in 2022, with
                                overpasses at Clark and Bee Ridge Roads expected to be finished by FDOT in 2024. The Venice
                                Area Historical Society provides more information on the Venice Train Depot and the Legacy
                                Trail corridor.</p>
                        </div>
                    </div>
                    <div class="lg:flex lg:flex-auto lg:justify-center">
                        <dl class="w-64 space-y-8 xl:w-80">
                            ...
                            <div class="flex flex-col-reverse gap-y-4">
                                ...
                                <dd class="text-5xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">600,000
                                </dd>
                            </div>
